                ...
                try {
                    ...
                    try {
                        ...
                        if (samlSession != null) {
                            ...
                            SAMLUtil.createLogLine(errorMessage, SSOLogResult.Failed);
                            //edit code - start //Error Status E001
                            throw new SAMLFeedbackException("User lookup failed.").addUserId(userPrincipal).addErrorStatus("E001").addFeedbackMessage("The authentication was successful, but there is no account available in this application.");
                            //edit code - end
                        }
